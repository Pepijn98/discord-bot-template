...
export default class Help extends Command {
    ...
    public async run(msg: Message, args: string[], client: Client, ctx: ICommandContext): Promise<Message | undefined> {
        if (args.length === 0) {
    ...
    public checkForMatch(name: string, client: Client, ctx: ICommandContext): Command | undefined {
